        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
                ...
                <p class="text-muted small mt-1 mb-0">
                    {{ $roles->total() }} {{ __('rôle(s) au total') }}
                </p>
            </div>

            @can(\App\Permissions\RolePermissions::CREATE)
                <a href="{{ route('admin.roles.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-lg me-2"></i>{{ __('Créer un rôle') }}
                </a>
            @endcan
        </div>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-end">
                                            ...
                                            @can(\App\Permissions\RolePermissions::DELETE)
                                                ...
                                                @else
                                                    <span class="text-muted" title="{{ __('Rôle système non supprimable') }}">
                                                        <i class="bi bi-trash fs-6"></i>
                                                    </span>
                                                @endif
                                            @endcan
