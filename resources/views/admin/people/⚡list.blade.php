            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="border-bottom">
                    <tr>
                        ...
                        <th class="text-body-secondary fw-medium small">{{ __('Personne') }}</th>
                        <th class="text-body-secondary fw-medium small">{{ __('Téléphone') }}</th>
                        <th class="text-body-secondary fw-medium small">{{ __('Email') }}</th>
                        <th class="text-body-secondary fw-medium small">{{ __('Rôle') }}</th>
